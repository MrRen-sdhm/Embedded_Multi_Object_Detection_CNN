...
logo_name = 'one-' + str(logonum) + '.png'
path_name = 'Back' + str(pathnum)
img_logo = cv2.imread('./logo/Onelogo/' + logo_name, cv2.IMREAD_COLOR)
...
while True:
    ...
    img_back = cv2.resize(img_back, (520, 300))
    ...
    cv2.rectangle(img_back_copy, (0, 0), (300, 300), (0, 255, 0), 2)
...
for backfileName in imagePaths:
    ...
    # 对logo进行随机缩放
    range = random.choice((0.6, 0.7, 0.8, 0.9, 1.0))
