...
logo_name = 'punch0506_' + str(logonum) + '.png'
path_name = 'Back' + str(pathnum)
img_logo = cv2.imread('./logo/Punchlogo/' + logo_name, cv2.IMREAD_COLOR)
...
while True:
    ...
    img_back = cv2.resize(img_back, (540, 320))
...
for backfileName in imagePaths:
    ...
    # 对logo进行随机缩放,Punch不可缩小太多，因其本来就较小
