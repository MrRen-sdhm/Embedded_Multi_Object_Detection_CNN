# USAGE
'''
python demo_camera_fps.py --prototxt squeezenet_ssd_deploy.prototxt \
--model models/squeezenet_ssd_iter_50000.caffemodel

# merge bn
python demo_camera.py --prototxt example/squeezenet_ssd_deploy_merge_bn.prototxt \
--model models/squeezenet_ssd_merge_bn.caffemodel

# from video
python demo_camera.py --prototxt example/squeezenet_ssd_deploy.prototxt \
--model models/squeezenet_ssd_iter_50000.caffemodel --video test.mp4
'''
