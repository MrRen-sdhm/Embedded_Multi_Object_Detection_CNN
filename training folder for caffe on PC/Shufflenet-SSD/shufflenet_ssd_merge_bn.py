...
shufflenet_ssd_root = caffe_root + 'examples/Shufflenet-SSD/'

train_proto = shufflenet_ssd_root + 'example/shufflenet_ssd_train.prototxt'
deploy_proto = shufflenet_ssd_root + 'example/shufflenet_ssd_deploy.prototxt'

train_model = shufflenet_ssd_root + 'snapshot/ShuffleNetSSD_iter_120000.caffemodel'
save_model = shufflenet_ssd_root + 'models/ShuffleNetSSD_mergebn.caffemodel'
