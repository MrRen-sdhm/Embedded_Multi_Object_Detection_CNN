# usage:
'''
python gen_model.py -s train -l labelmap.prototxt -d trainval_lmdb -c 7 \
>MobileNetV2SSDLite_train.prototxt
python gen_model.py -s deploy -l labelmap.prototxt -d trainval_lmdb -c 7 \
>MobileNetV2SSDLite_deploy.prototxt
python gen_model.py -s test -l labelmap.prototxt -d test_lmdb -c 7 \
>MobileNetV2SSDLite_test.prototxt
'''
import argparse
FLAGS = None
