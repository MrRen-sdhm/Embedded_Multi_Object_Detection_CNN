...
path='./example'
sed -i "s/\<conv1$suffix_old\>/conv1$suffix_new/g"  `grep conv1$suffix_old -rl $path`
sed -i "s/\<fire2_squeeze1x1$suffix_old\>/fire2_squeeze1x1$suffix_new/g"  `grep fire2_squeeze1x1$suffix_old -rl $path`
sed -i "s/\<fire9_mbox_loc$suffix_old\>/fire9_mbox_loc$suffix_new/g"  `grep fire9_mbox_loc$suffix_old -rl $path`
sed -i "s/\<fire9_mbox_conf$suffix_old\>/fire9_mbox_conf$suffix_new/g"  `grep fire9_mbox_conf$suffix_old -rl $path`
sed -i "s/\<fire10_mbox_loc$suffix_old\>/fire10_mbox_loc$suffix_new/g"  `grep fire10_mbox_loc$suffix_old -rl $path`
